...
Select the emulated machine by I<name>. Use C<-machine ?> to list
...
I<cache> is "none", "writeback", "unsafe", "directsync" or "writethrough" and controls how the host cache is used to access block data.
...
Open drive B<file> as read-only. Guest write attempts will fail.
...
=item B<-boot [order=>I<drives>B<][,once=>I<drives>B<][,menu=on|off][,splash=>I<sp_name>B<][,splash-time=>I<sp_time>B<]>
...
=item B<-fsdev> I<fsdriver>B<,id=>I<id>B<,path=>I<path>B<,[security_model=>I<security_model>B<][,writeout=>I<writeout>B<][,readonly]>
...
=item B<-virtfs> I<fsdriver>B<,path=>I<path>B<,mount_tag=>I<mount_tag>B<,security_model=>I<security_model>B<[,writeout=>I<writeout>B<][,readonly]>
...
=item B<tls-channel=[main|display|inputs|record|playback|tunnel]>


=item B<plaintext-channel=[main|display|inputs|record|playback|tunnel]>
...
=item B<-net socket[,vlan=>I<n>B<][,name=>I<name>B<][,fd=>I<h>B<][,mcast=>I<maddr>B<:>I<port>B<[,localaddr=>I<addr>B<]]>
...
"sheepdog:E<lt>vdinameE<gt>"

"sheepdog:E<lt>vdinameE<gt>:E<lt>snapidE<gt>"

"sheepdog:E<lt>vdinameE<gt>:E<lt>tagE<gt>"

"sheepdog:E<lt>hostE<gt>:E<lt>portE<gt>:E<lt>vdinameE<gt>"

"sheepdog:E<lt>hostE<gt>:E<lt>portE<gt>:E<lt>vdinameE<gt>:E<lt>snapidE<gt>"

"sheepdog:E<lt>hostE<gt>:E<lt>portE<gt>:E<lt>vdinameE<gt>:E<lt>tagE<gt>"
...
See also E<lt>B<http://http://www.osrg.net/sheepdog/>E<gt>.
...
=item B<-toggle-kvm> I<file>

Toggle KVM on or off at runtime. 

=item B<-after_loadvm> I<file>

NO DESCRIPTION

=item B<-load-plugin> I<file>
...
=item B<-trace [events=>I<file>B<][,file=>I<file>B<]>
...
The file must contain one event name (as listed in the I<trace-events> file)
per line.
This option is only available if QEMU has been compiled with
either I<simple> or I<stderr> tracing backend.
